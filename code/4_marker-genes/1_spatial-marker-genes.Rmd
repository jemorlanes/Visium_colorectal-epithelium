...
Setting directories
```{r}
st.dir <- "/Users/javierescudero/Documents/work/Helmsley_wLudvigL/data/Visium/Colon/data/curated"
vis.dir <- "/Users/javierescudero/Documents/work/Helmsley_wLudvigL/results/Colon_Alexandre/HV-QCed/mapping_genes"
```

# Summary
In this markdown we want to check the distribution of marker genes for celltypes EEC and ECC. Apparently we overestimate them in stereoscope, so we are gonna try to see how these markers distribute across the sections. Perhaps the proportions look assy, but the marker genes look okay.

# Analysis
## Loading ST data
For QC, we have an rds
```{r}
